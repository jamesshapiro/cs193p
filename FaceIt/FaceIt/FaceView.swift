...
class FaceView: UIView
{
    ...
    private func pathForMouth() -> UIBezierPath
    {
        ...
        let controlPointOne = CGPoint(x: start.x + mouthRect.width / 3, y: start.y + smileOffset)
        let controlPointTwo = CGPoint(x: end.x - mouthRect.width / 3, y: start.y + smileOffset)
